...
let customIcon = L.icon({
    iconUrl: '/assests/icons/Logo.png', // URL de tu logo
    iconSize: [40, 40], // Tamaño del ícono, ajusta según sea necesario
    iconAnchor: [20, 40], // Punto del ícono que corresponderá a la ubicación del marcador
    popupAnchor: [0, -40] // Punto desde donde se abrirá el popup, si es necesario ajustarlo
});
...
apMarker.bindPopup("<b>Netwerk-Protocollen</b><br>Ellermanstraat 33").openPopup();